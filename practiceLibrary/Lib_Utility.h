...
class AnalogSensor{
  ...
  float _B;
  public:
  void Init(int p, int m, int t, bool i, float cm, float cb);
  bool IsTrue();
...
class Buzzer{
  ...
  float _pauseScale;
  public:
  void Init(int p, int ps, int wnp);
...
class Sweeper{
  ...
  public:
  void Init(int s, int e, int st, byte x);
